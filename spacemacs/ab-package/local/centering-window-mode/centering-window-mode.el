...
(define-minor-mode centering-window-mode
  (if centering-window-mode
      (centering-teardown)
    (centering-setup)))

;;;###autoload
(defun centering-window-mode-on ()
  (interactive)
  (if (not centering-window-mode) (centering-window-mode 1))
  )

;;;###autoload
(defun centering-window-mode-off ()
  (interactive)
  (if (centering-window-mode) (centering-window-mode 0))
  )
